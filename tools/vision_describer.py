...
def describe_image(
    ...
    """
    if not isinstance(image_path, str) or not image_path.strip() or len(image_path) > 4096 or "\0" in image_path:
        return "Error: image_path must be a valid file path"
    ...
    try:
        ...
        return f"Error: Could not inspect image file: {exc}"
